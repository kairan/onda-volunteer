  ...
  return (
    <section className="flex flex-col gap-8">
      <div className="rounded-md border border-border bg-surface p-6">
        ...
        <h1 className="mt-3 text-3xl font-semibold leading-tight">{data.event.title}</h1>
        {isCancelled ? (
        ...
        <p className="mt-2 text-xs text-muted-foreground">{t('scheduling.readOnlyNotice')}</p>
      </div>

      <div className="rounded-md border border-border bg-surface p-6">
        <h2 className="text-lg font-semibold">{t('scheduling.detail.assignmentsHeading')}</h2>
