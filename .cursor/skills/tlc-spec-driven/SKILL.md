...
**Onda Volunteer (brownfield):** Read [ONDA.md](ONDA.md) before any TLC phase — it maps upstream outputs to existing repo docs and overrides paths where this project diverges from the default `.specs/` layout.
