...
const demoEnv = {
  ...
  VITE_DEMO_EVENT_ID: process.env.VITE_DEMO_EVENT_ID ?? 'seed-event-public',
  VITE_DEMO_MINISTRY_ID:
    process.env.VITE_DEMO_MINISTRY_ID ?? 'seed-ministry-demo',
  VITE_DEMO_ROLE_ID: process.env.VITE_DEMO_ROLE_ID ?? 'seed-role-greeter',
};
