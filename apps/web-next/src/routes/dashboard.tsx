  ...
  return (
    <div className="mx-auto max-w-6xl space-y-8">
      ...
      <section aria-label={t('preview.timeAwayHeading')}>
        ...
        {loading ? (
          <Card className="overflow-hidden rounded-lg border border-border p-4 shadow-[var(--shadow-card)]">
            <Skeleton className="h-12 w-full" />
            <Skeleton className="mt-3 h-12 w-full" />
          </Card>
        ) : previewRows.length === 0 ? (
          <Card className="rounded-lg border border-border p-6 text-center text-sm text-muted-foreground shadow-[var(--shadow-card)]">
