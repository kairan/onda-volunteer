# 36 — Scheduling hub: Church-scoped Event list + read visibility

**Status:** Shipped  
**GitHub:** [#36](https://github.com/kairan/onda-volunteer/issues/36) (closed)

**Type:** AFK  
**Normative refs:** `docs/prd/volunteer-management-platform.md` (stories **#18–22**, **37**); `docs/prd/web-client-design-system-shell-i18n.md` (stories **20**, **32**); `CONTEXT.md`
...
- issue **#37** — shell roster read + fix scheduling → detail navigation (GitHub **#37**).
