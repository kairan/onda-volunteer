# 53 — Web: Playwright browser e2e foundation
...
- [ ] **35** — Shell roster read at `/scheduling/events/$eventId` + Playwright authorized/unauthorized paths.
- [ ] **36** — Assign / release / **Unavailability** offer flows in browser (happy path + one domain error).
- [ ] **52** — After legacy retirement, Playwright targets shell routes only (no `/events/$eventId`).
- [ ] **47** — Keyboard-only smoke for **Scheduling** and **Time away** (WCAG release gate).
...
- Nothing for foundation. Product flows depend on slices **35** / **36** shipping.
...
- Slice **35** — [#37](https://github.com/kairan/onda-volunteer/issues/37)
- Slice **36** — [#38](https://github.com/kairan/onda-volunteer/issues/38)
- Slice **52** — [#58](https://github.com/kairan/onda-volunteer/issues/58)
- Slice **47** — [#49](https://github.com/kairan/onda-volunteer/issues/49)
