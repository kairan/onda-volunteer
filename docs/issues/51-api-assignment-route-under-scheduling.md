# 51 — API: **Assignment** create route under **Scheduling** (tech debt)
...
- [ ] Web shell roster (slice **36**) uses the new route.
- [ ] Legacy route removed or returns clear deprecation if still called.
- [ ] E2e assign scenarios updated; behavior unchanged.

## When to schedule

- **After** slice **36** when API cleanup is low risk.

## Blocked by

- Slice **36** — shell roster writes (GitHub [#38](https://github.com/kairan/onda-volunteer/issues/38))
