# 54 — API: **Scheduling** invariants module (tech debt)
...
- **After** issue **#38** (shell roster writes) ships, **or**
- **During** issue **#44** if bulk mirror work exposes untested validation paths.

## Blocked by

- issue **#38** — Event roster writes (GitHub [#38](https://github.com/kairan/onda-volunteer/issues/38)) — recommended, not strict
