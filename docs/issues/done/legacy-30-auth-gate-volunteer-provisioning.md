...
**Normative refs:** `docs/prd/volunteer-management-platform.md` (stories **1**, **38**); `docs/issues/done/legacy-07-supabase-auth-identity-mapping.md`; `CONTEXT.md` (**Identity**, **Volunteer**)

## Parent

- Platform PRD: `docs/prd/volunteer-management-platform.md`
- Prior auth slice: `docs/issues/done/legacy-07-supabase-auth-identity-mapping.md`
