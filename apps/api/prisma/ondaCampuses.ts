 ...
 *
 * Demo seed models each region as a separate Church so the church selector has
 * multiple tenants. Production language in CONTEXT.md still treats Igreja Onda
 * Dura as one Church with campuses (Joinville sede, Porto, etc.).
 */
...
export const ONDA_REGIONAL_CHURCHES: OndaRegionalChurchSeed[] = [
  ...
  {
    id: 'seed-church-japao',
    name: 'Onda Japão',
    defaultTimezone: 'Asia/Tokyo',
    campuses: [
      { id: 'seed-campus-hamamatsu', name: 'Hamamatsu', timezone: 'Asia/Tokyo' },
    ],
  },
];
