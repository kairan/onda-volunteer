# 45 — Admin delegates Leaders across Churches

**Type:** HITL  
**Label when unblocked:** `ready-for-agent`  
**Normative refs:** `docs/prd/volunteer-management-platform.md` (stories **14**, **20–21**); `CONTEXT.md`
...
- Slice **44** — Admin manages Ministry membership lifecycle (GitHub **#46**)
