...
- **2026-07-28 (#175 Phase 5 cutover closeout):** Production frontend → `@onda/web-onda` only. Deleted `apps/web` + `apps/web-next`; CI/root scripts retargeted; redirects runbook; design.md §9 signed; Verifier PASS; PR [#184](https://github.com/kairan/onda-volunteer/pull/184) merged. Record: `docs/issues/done/175-web-onda-phase-5-cutover.md`. TLC `frontend-restart-serve-well-base` archived per AD-001.

- **AD-002 (2026-07-16):** Official **Brandbook 2027** is the source of truth for `apps/web-onda` visuals — palette (primary `#2537de`; app canvas `#f4f4f2` aligned with ondadura.com.br; BrandBook `#eeeee7` on auth gradient), Logo 1 PNG wordmark **`igreja onda`**, Balanced grafismos, Space Grotesk UI + Right Grotesk display; **SF Pro = print/marketing only** (no web embedding). Amended ADR [0006](../../docs/adr/0006-onda-brand-visual-system.md). **Shipped** [#180](https://github.com/kairan/onda-volunteer/issues/180) / PR [#182](https://github.com/kairan/onda-volunteer/pull/182) (2026-07-17); TLC archived [`.specs/archive/features/official-brandbook-web-onda/`](../archive/features/official-brandbook-web-onda/). Ship record: `docs/issues/done/180-web-onda-official-brandbook.md`. **#175 cutover executed 2026-07-28.**
