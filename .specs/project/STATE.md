...
- **2026-06-21 (`frontend-migration-web-next` Slice 2–5 tracker sync):** After #143 closeout, synced open issues #144–#147: volunteer nav IA split (`/dashboard` home vs `/scheduling` My Assignments) reflected in T16/T16.5, active specs in `docs/issues/144-*` … `147-*`, `ready-for-agent` on unblocked slices. #148 remains blocked until 144–147 ship.
