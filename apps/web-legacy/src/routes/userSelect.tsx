          ...
          return (
            <li key={persona.id}>
              <button
                type="button"
                className={cn(
                  'w-full border-2 border-border bg-surface p-4 text-left shadow-[4px_4px_0_0_hsl(var(--border))] transition-colors hover:bg-primary/10',
...
function DevPickerLayout({ children }: { children: React.ReactNode }) {
  return (
